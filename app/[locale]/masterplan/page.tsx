              ...
              {isZoomed ? (
                ...
                >
                  ...
                  <button
                    ...
                    className='cursor-pointer absolute right-6 top-6 flex size-10 items-center justify-center rounded-full text-white/90 shadow-lg transition hover:scale-105'
                  >
